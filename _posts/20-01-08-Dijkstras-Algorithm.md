...
#   go in infinate loop.
#
# At the end of Algorithm execution, costs_table will have the least cost to any given node from the
# Start node. The parents_table can be used to print the Shortest path from Finish node to any node.
