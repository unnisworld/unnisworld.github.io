...
In the example Graph above, you are connected to Bob, Claire and Alice. How do you represent You -> Bob? That's exactly what a hashtable or dictionary is for. Remember a hashtable or dictionary allows you to map a key to a value.
